...
![科赫雪花:从正三角形出发,每一步把每条边中间的三分之一换成"凸起",0 到 6 阶|308](../../assets/img/koch-snowflake.gif)
...
![谢尔宾斯基三角形:每次挖掉正中心的三角形,0 到 6 阶|314](../../assets/img/sierpinski.gif)
...
![自相似维数:线段分成 3 段(放大 3 倍还是自己),正方形分成 4 块(放大 2 倍还是自己),科赫曲线分成 4 段(放大 3 倍还是自己)|492](../../assets/img/dim-compare.png)
...
> 顺带一提:本文的图全部用 Mathematica 画成——科赫雪花是 `KochCurve[n]`,谢尔宾斯基三角形是 `SierpinskiMesh[n]`,各画 0~6 阶拼成动画。这两个函数内置,打开软件几秒钟就能复现;你甚至可以拉到 8 阶、10 阶,看细节如何无限繁殖。
