...
date: 2026-08-22
tags: [数学, 函数]
excerpt: 只告诉你 f(x+y)=f(x)+f(y)，不给你公式，能挖出多少秘密？聊聊赋值法、初等函数的"指纹方程"，以及一个必须提防的怪物。
---
...
写下这条方程时，柯西心里想的都是"正常"的函数。但总有人较真：**如果什么都不补——既不许假设连续，也不许假设单调呢？** 1905 年，哈默（Hamel）证明：怪解不但存在，还多得很。存在处处满足 $f(x+y)=f(x)+f(y)$、却在任何一点都不连续的函数；更夸张的是，它们的图像在坐标平面上**稠密**——随便戳一个点，附近都趴着这条"曲线"上的点，可你永远画不出它。
