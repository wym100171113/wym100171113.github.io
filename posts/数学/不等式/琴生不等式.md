...
![凸函数的弦:连接 (x,f(x)) 与 (y,f(y)) 的线段在图像上方, 中点处 f(m) ≤ (f(x)+f(y))/2|560](../../assets/img/jensen-chord.png)
...
![弦的斜率: 三点 x1<x2<x3 的两条弦, 斜率 k1 ≤ k2, 即 f′ 单调不减|560](../../assets/img/jensen-slope.png)
...
![凸函数与切线: 切线处处在图像下方, f″ ≥ 0 保证 f′ 单调不减|560](../../assets/img/jensen-tangent.png)
